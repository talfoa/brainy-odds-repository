...
describe('GameEvent e2e test', () => {
  ...
  it('should load GameEvents', async () => {
    ...
    expect(await gameEventComponentsPage.getTitle()).to.eq('brainyoddsApp.gameEvent.home.title');
  ...
  it('should load create GameEvent page', async () => {
    ...
    expect(await gameEventUpdatePage.getPageTitle()).to.eq('brainyoddsApp.gameEvent.home.createOrEditLabel');
  ...
  it('should delete last GameEvent', async () => {
    ...
    expect(await gameEventDeleteDialog.getDialogTitle()).to.eq('brainyoddsApp.gameEvent.delete.question');
