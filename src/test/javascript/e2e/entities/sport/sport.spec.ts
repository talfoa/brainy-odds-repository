...
describe('Sport e2e test', () => {
  ...
  it('should load Sports', async () => {
    ...
    expect(await sportComponentsPage.getTitle()).to.eq('brainyoddsApp.sport.home.title');
  ...
  it('should load create Sport page', async () => {
    ...
    expect(await sportUpdatePage.getPageTitle()).to.eq('brainyoddsApp.sport.home.createOrEditLabel');
  ...
  it('should delete last Sport', async () => {
    ...
    expect(await sportDeleteDialog.getDialogTitle()).to.eq('brainyoddsApp.sport.delete.question');
