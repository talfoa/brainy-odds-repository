...
describe('ScoreBoard e2e test', () => {
  ...
  it('should load ScoreBoards', async () => {
    ...
    expect(await scoreBoardComponentsPage.getTitle()).to.eq('brainyoddsApp.scoreBoard.home.title');
  ...
  it('should load create ScoreBoard page', async () => {
    ...
    expect(await scoreBoardUpdatePage.getPageTitle()).to.eq('brainyoddsApp.scoreBoard.home.createOrEditLabel');
  ...
  it('should delete last ScoreBoard', async () => {
    ...
    expect(await scoreBoardDeleteDialog.getDialogTitle()).to.eq('brainyoddsApp.scoreBoard.delete.question');
