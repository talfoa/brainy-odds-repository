...
describe('Match e2e test', () => {
  ...
  it('should load Matches', async () => {
    ...
    expect(await matchComponentsPage.getTitle()).to.eq('brainyoddsApp.match.home.title');
  ...
  it('should load create Match page', async () => {
    ...
    expect(await matchUpdatePage.getPageTitle()).to.eq('brainyoddsApp.match.home.createOrEditLabel');
  ...
  it('should delete last Match', async () => {
    ...
    expect(await matchDeleteDialog.getDialogTitle()).to.eq('brainyoddsApp.match.delete.question');
