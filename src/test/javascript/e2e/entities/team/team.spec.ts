...
describe('Team e2e test', () => {
  ...
  it('should load Teams', async () => {
    ...
    expect(await teamComponentsPage.getTitle()).to.eq('brainyoddsApp.team.home.title');
  ...
  it('should load create Team page', async () => {
    ...
    expect(await teamUpdatePage.getPageTitle()).to.eq('brainyoddsApp.team.home.createOrEditLabel');
  ...
  it('should delete last Team', async () => {
    ...
    expect(await teamDeleteDialog.getDialogTitle()).to.eq('brainyoddsApp.team.delete.question');
