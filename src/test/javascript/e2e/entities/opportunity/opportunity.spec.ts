...
describe('Opportunity e2e test', () => {
  ...
  it('should load Opportunities', async () => {
    ...
    expect(await opportunityComponentsPage.getTitle()).to.eq('brainyoddsApp.opportunity.home.title');
    await browser.wait(
  ...
  it('should load create Opportunity page', async () => {
    ...
    expect(await opportunityUpdatePage.getPageTitle()).to.eq('brainyoddsApp.opportunity.home.createOrEditLabel');
  ...
  it('should delete last Opportunity', async () => {
    ...
    expect(await opportunityDeleteDialog.getDialogTitle()).to.eq('brainyoddsApp.opportunity.delete.question');
