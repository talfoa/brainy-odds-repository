...
describe('League e2e test', () => {
  ...
  it('should load Leagues', async () => {
    ...
    expect(await leagueComponentsPage.getTitle()).to.eq('brainyoddsApp.league.home.title');
  ...
  it('should load create League page', async () => {
    ...
    expect(await leagueUpdatePage.getPageTitle()).to.eq('brainyoddsApp.league.home.createOrEditLabel');
  ...
  it('should delete last League', async () => {
    ...
    expect(await leagueDeleteDialog.getDialogTitle()).to.eq('brainyoddsApp.league.delete.question');
