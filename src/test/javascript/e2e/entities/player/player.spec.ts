...
describe('Player e2e test', () => {
  ...
  it('should load Players', async () => {
    ...
    expect(await playerComponentsPage.getTitle()).to.eq('brainyoddsApp.player.home.title');
  ...
  it('should load create Player page', async () => {
    ...
    expect(await playerUpdatePage.getPageTitle()).to.eq('brainyoddsApp.player.home.createOrEditLabel');
  ...
  it('should delete last Player', async () => {
    ...
    expect(await playerDeleteDialog.getDialogTitle()).to.eq('brainyoddsApp.player.delete.question');
