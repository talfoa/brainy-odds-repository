...
export class LeagueComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.leagueService
      ...
      .subscribe(
        (res: HttpResponse<ILeague[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLeagues(): void {
    this.eventSubscriber = this.eventManager.subscribe('leagueListModification', () => this.loadPage());
  }
