...
export class OpportunityComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.opportunityService
      ...
      .subscribe(
        (res: HttpResponse<IOpportunity[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IOpportunity[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
