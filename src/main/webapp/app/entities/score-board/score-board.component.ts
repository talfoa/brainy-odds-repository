...
export class ScoreBoardComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.scoreBoardService
      ...
      .subscribe(
        (res: HttpResponse<IScoreBoard[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInScoreBoards(): void {
    this.eventSubscriber = this.eventManager.subscribe('scoreBoardListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IScoreBoard[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
