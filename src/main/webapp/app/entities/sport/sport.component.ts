...
export class SportComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.sportService
      ...
      .subscribe(
        (res: HttpResponse<ISport[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ISport[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
